...
import { useStudentEnrollCourse } from "@/features/student/course/hooks/use-student-enroll-course.ts";
import { useNavigate } from "@tanstack/react-router";

interface CourseItemProps {
  course: AssignedCourseForStudent;
}

export const CourseItem: React.FC<CourseItemProps> = ({ course }) => {
  const navigate = useNavigate();
  const enrollMutation = useStudentEnrollCourse();
